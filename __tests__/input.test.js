...
describe('parseLatestVersion', () => {
  it('returns latest version for tags', () => {
    expect(parseLatestVersion('', ['1.0.0', '1.0.1', '1.1.0', '1.01.0'])).toEqual(new Version(1, 1, 0))
  })
  it('filters tags by prefix', () => {
    expect(parseLatestVersion('v', ['v1.0.0', '1.0.1', '1.1.0', '1.01.0'])).toEqual(new Version(1, 0, 0))
  })
  it('handles invalid tags', () => {
    expect(parseLatestVersion('', ['1.0.0', '1.0.1', '1.00.1', '1.1', 'invalid'])).toEqual(new Version(1, 0, 1))
  })
